...
# Local agent contract: `tools/`

## Scope

Repository maintenance, documentation, parity, audit, and preflight tools. This file adds local constraints to every ancestor `AGENTS.md`;
