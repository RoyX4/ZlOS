...
OVERRIDES = {
    ...
    "EV-004": ("PROVED_CURRENT", (
               ...
               ("archive cache is retained only on the current host",
                "rolling-distribution archive custody is bound to the recorded signed index, not future archive availability",
                "off-host custody and hermetic rebuild remain EV-002/EV-005 work"),
               "the current host dependency and binary/source archive closure resolves offline with zero undeclared dependency edges; exact inventory counts are retained in the joined receipt"),
    "EV-005": ("PARTIAL_CURRENT", (("implementation", "kernel/metadata/toolchain-manifest.json"),
               ...
               "7 tools, 4 ABI lanes and the measured external-header closure are exact locally, but the toolchain is not hermetic or source-custodied"),
