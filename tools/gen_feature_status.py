...
OVERRIDES = {
    ...
    "EV-012": ("PROVED_CURRENT", (("implementation", "kernel/hosttest/test-inventory.json"),
                                   ("implementation", "kernel/hosttest/test-run-receipt.json")),
               ("python3 kernel/run-host-tests.py --selftest",),
               ("kernel/hosttest/test-inventory.json", "kernel/hosttest/test-run-receipt.json"),
    ...
    "EV-018": ("PARTIAL_CURRENT", (
                   ("implementation", "kernel/hosttest/trace_event.c"),
                   ("implementation", "kernel/hosttest/trace_event.h"),
