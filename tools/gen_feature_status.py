...
OVERRIDES = {
    ...
    "EV-012": ("HISTORICAL_ONLY", (("implementation", "kernel/tests/host/test-inventory.json"),
               ...
               "the dated 73-target receipt records 59 passes, 3 hardware skips and 11 manual/instrument non-runs; it is not build-identity bound"),
    "EV-013": ("PARTIAL_CURRENT", (("implementation", "kernel/metadata/adversarial-registry.json"),),
               ...
               "19 current verifier canaries proved red; four hostile-corpus families and all exhaustive failure-family claims remain open"),
    ...
    "EV-016": ("PARTIAL_CURRENT", (("implementation", "kernel/metadata/visual-registry.json"),),
    ...
    "EV-022": ("PARTIAL_CURRENT", (("implementation", "kernel/metadata/visual-registry.json"),),
               ("python3 kernel/tools/generators/gen-visual-registry.py --check --selftest",),
               ("kernel/metadata/visual-registry.json",),
    ...
    "KR-032": ("PARTIAL_CURRENT", (("implementation", "kernel/src/core/crash.c"),
               ...
               ("python3 kernel/tools/checks/verify-crash.py --run --no-build --selftest",
