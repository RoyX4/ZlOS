...
REPO_REF='(^|[^A-Za-z0-9_./-])(kernel|docs|tools|examples|tests|freestanding|stdlib|editors|\.github)/[A-Za-z0-9_./-]+\.(c|h|zl|sh|md|txt|json|yml)\b'
...
DOCS=$(git ls-files '*.md' 2>/dev/null \
       | grep -vE '^(TODO\.md|docs/JOURNAL\.md|\.github/pull_request_template\.md|docs/archive/)')
