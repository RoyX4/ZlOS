#!/usr/bin/env python3
"""Generate and validate the exact closure program for current partial features."""
...
CONTRACTS = {
    ...
    "EV-004": contract("H1_HOST_TRUTH", ("EV-002", "EV-003", "EV-005"),
        ...
        "Add transitive package, source-archive, firmware and binary relationships to the dependency lock."),
    ...
    "EV-014": contract("X2_PHYSICAL", ("EV-005", "EV-009", "EV-021"),
        ...
        "Upgrade the host benchmark receipt to retain raw samples, percentiles, peaks and machine identity."),
    "EV-015": contract("X2_PHYSICAL", ("EV-009", "EV-014"),
        ...
        ("receipt rejects wrong artifact, firmware, topology, device, lane or missing raw evidence",),
        ...
        "Prepare the hardware receipt runner and device matrix without claiming a physical run."),
    "EV-016": contract("Q1_CONTAINED_RUNTIME", ("EV-009", "EV-022", "EV-023"),
        ...
        ("required native display captures bind to physical receipts",), (), True,
        ...
        "Add deterministic QEMU capture and bind new goldens to the current artifact identity."),
    "EV-017": contract("Q1_CONTAINED_RUNTIME", ("EV-009", "EV-018", "EV-024", "KR-032"),
        ...
        "Extend the typed exception frame to all general registers and define a double-fault-safe crash store."),
    ...
    "EV-019": contract("B1_CROSS_PHASE_FOUNDATION", ("EV-013", "EV-020", "EV-024"),
        ...
        "Generate injection points for current allocation, queue and I/O commit paths, then compare pre/post state."),
    "EV-020": contract("B1_CROSS_PHASE_FOUNDATION", ("EV-013", "EV-019", "EV-024"),
        ...
        "Add ELF, archive and font host corpora now; add IPC cases when the typed transport lands."),
    "EV-021": contract("Q1_CONTAINED_RUNTIME", ("EV-014", "EV-016", "EV-019", "EV-022"),
        ...
        "Register current input, block I/O, network, launch, memory and build metrics beside frame timings."),
    "EV-022": contract("Q1_CONTAINED_RUNTIME", ("EV-016", "EV-023", "EV-028"),
        ...
        ("native display lane confirms required hardware-specific output",), (), True,
        ...
        "Establish current QEMU goldens only after the build-bound capture runner exists."),
    ...
    "KR-032": contract("Q1_CONTAINED_RUNTIME", ("KR-006", "KR-007", "KR-009", "EV-017", "EV-024"),
        ...
        "Capture every general register in the typed frame, then add offender-only Ring-3 fault recovery in contained QEMU."),
}
