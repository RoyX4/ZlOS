...
# Local agent contract: `examples/`

## Scope

Runnable zl examples that also participate in repository test coverage. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Preserve the stated scope of the proof lane; do not generalize a bounded result.
