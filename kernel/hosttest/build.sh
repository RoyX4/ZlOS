...
gcc -O2 -Wall -Wextra -Werror -DZL_64 -o i2ctest \
    i2ctest.c ../i2c_hid.c ../i2c_touch.c
echo "built ./i2ctest       (run: ./i2ctest)"

gcc -O2 -Wall -Wextra -Werror -o i2c_touchtest \
    i2c_touchtest.c ../i2c_touch.c
...
gcc -O1 -g -Wall -Wextra -DIWLWIFI_HOSTTEST \
    -o iwlwifitest iwlwifitest.c ../iwlwifi.c ../crypto.c
