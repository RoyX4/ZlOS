...
"<h2>Start here</h2>\n"
"<ul>\n"
"<li><strong>Terminal</strong> - type <code>h</code> for commands</li>\n"
"<li><strong>Apps</strong> - launch them from the centred dock</li>\n"
"<li><strong>Windowing</strong> - drag, resize, snap, minimise and restore</li>\n"
"<li><strong>Network</strong> - open a real <code>http://</code> address</li>\n"
"</ul>\n"
"<h2>Browser</h2>\n"
"<p>The address field accepts <code>http://</code>. Try "
"<a href=\"http://example.com/\">example.com</a>. Pages reflow when this "
"window is resized.</p>\n"
"<h3>Current limits</h3>\n"
"<p>HTTPS, JavaScript and downloadable CSS are not implemented yet. zlOS "
"does not display a padlock it has not earned.</p>\n"
"</body></html>\n";
