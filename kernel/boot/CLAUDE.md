...
# Local agent contract: `kernel/boot/`

## Scope

BIOS, raw, long-mode, and native UEFI entry code and linker layouts. This file adds local constraints to every ancestor `AGENTS.md`;
