...
# Local agent contract: `kernel/tools/run/`

## Scope

Bounded launchers for QEMU and local kernel exercises. This file adds local constraints to every ancestor `AGENTS.md`;
