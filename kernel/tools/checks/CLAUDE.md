...
# Local agent contract: `kernel/tools/checks/`

## Scope

Deterministic static, host, image, and boot verification entry points. This file adds local constraints to every ancestor `AGENTS.md`;
