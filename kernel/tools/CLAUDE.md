...
# Local agent contract: `kernel/tools/`

## Scope

Kernel checks, generators, image builders, probes, and runners. This file adds local constraints to every ancestor `AGENTS.md`;
