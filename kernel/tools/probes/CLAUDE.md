...
# Local agent contract: `kernel/tools/probes/`

## Scope

Runtime probes that inspect QEMU or retained evidence outputs. This file adds local constraints to every ancestor `AGENTS.md`;
