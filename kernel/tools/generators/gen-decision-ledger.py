...
OUTPUT = METADATA / "decision-ledger.json"
...
RECORDS = (
    ...
    },
    {
        ...
        "status": "SUPERSEDED", "features": ["DV-031"],
        ...
        "source": "kernel/HANDOFF.md",
        "needle": "it is a **transport with\nno decoder**.",
        "legacy_labels": [], "supersedes": [], "replaced_by": "DEC-0020",
        "obsolete_evidence": ["The former no-decoder state and any completion claim based only on raw-byte diagnostics"],
    },
    {
    ...
    {
        "id": "DEC-0020", "date": "2026-08-24", "action": "REVERSAL",
        "status": "ACTIVE", "features": ["DV-031"],
        "decision": "Recognize the physical I2C-HID transport, report decoder and compositor route while keeping touchpad feel gestures open.",
        "rationale": "A physical ThinkPad trace proves cursor movement and click edges, superseding the older no-decoder state without inventing tap, scroll or feel completion.",
        "source": "kernel/HANDOFF.md",
        "needle": "Transport, decoder and compositor routing are therefore physical",
        "legacy_labels": [], "supersedes": ["DEC-0012"], "replaced_by": None,
        "obsolete_evidence": [],
    },
)
