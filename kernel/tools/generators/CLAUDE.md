...
# Local agent contract: `kernel/tools/generators/`

## Scope

Generators for registries, manifests, evidence views, and source data. This file adds local constraints to every ancestor `AGENTS.md`;
