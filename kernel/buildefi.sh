...
font_sub.c icons.c pci.c bga.c intel.c xhci.c console.c divmod.c gdt64.c idt.c apic.c virtio_gpu.c cpu.c nvme.c sched.c smp.c i2c_hid.c input.c wm.c ui.c wmglue.c term.c virtio_net.c net.c dns.c tcp.c http.c html.c layout.c browser.c settings.c fs.c clip.c snap.c notify.c rtc.c arena.c exec.c; do
