...
- typed process/app/window start, ready, exit, fault and refusal lifecycle;
- every 32/64-bit user-mode syscall begin and signed result/error;
- zlfs format/mount/find/create/read/write/delete/rename/sync operations;
- owned window open/present/poll/close operations;
- correlated asynchronous TCP connect, DNS resolve and HTTP request outcomes;
- TCP send/receive/close/abort results;
