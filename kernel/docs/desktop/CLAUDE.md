...
# Local agent contract: `kernel/docs/desktop/`

## Scope

Desktop interaction, pacing, workspace, and visual-system documentation. This file adds local constraints to every ancestor `AGENTS.md`;
