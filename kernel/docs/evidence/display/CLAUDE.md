...
# Local agent contract: `kernel/docs/evidence/display/`

## Scope

Structured display research and modesetting evidence. This file adds local constraints to every ancestor `AGENTS.md`;
