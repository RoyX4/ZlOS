...
# Local agent contract: `kernel/docs/evidence/`

## Scope

Dated zlOS implementation, QEMU, and physical evidence receipts. This file adds local constraints to every ancestor `AGENTS.md`;
