...
# Local agent contract: `kernel/docs/evidence/mp00/`

## Scope

MP-00 foundation execution and coverage receipts. This file adds local constraints to every ancestor `AGENTS.md`;
