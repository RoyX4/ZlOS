...
# Local agent contract: `kernel/docs/evidence/exercises/`

## Scope

Curated exercise bundles retained with provenance and limits. This file adds local constraints to every ancestor `AGENTS.md`;
