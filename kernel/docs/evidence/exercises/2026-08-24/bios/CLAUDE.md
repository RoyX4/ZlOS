...
# Local agent contract: `kernel/docs/evidence/exercises/2026-08-24/bios/`

## Scope

Retained BIOS exercise frames and transcript from 2026-08-24. This file adds local constraints to every ancestor `AGENTS.md`;
