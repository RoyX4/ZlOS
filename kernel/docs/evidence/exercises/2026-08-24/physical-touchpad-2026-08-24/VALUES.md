...
# Values: `kernel/docs/evidence/exercises/2026-08-24/physical-touchpad-2026-08-24/`

- **Provenance.** Apply it to every change in this directory.
- **Immutability of observations.** Apply it to every change in this directory.
- **Evidence-lane separation.** Apply it to every change in this directory.
