...
# Tasks: `kernel/docs/evidence/exercises/2026-08-24/physical-touchpad-2026-08-24/`

This directory is classified as `evidence`, so it has no default active implementation queue. Changes must originate in the current owner, generator, or a new superseding receipt.

Use the [remaining-work map](../../../../../../docs/REMAINING-WORK.md) for the current cross-directory queue and the [complete program](../../../../../../docs/program/README.md) for
