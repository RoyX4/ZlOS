...
# Local agent contract: `kernel/docs/evidence/exercises/2026-08-24/`

## Scope

Exercise bundles captured on 2026-08-24. This file adds local constraints to every ancestor `AGENTS.md`;
