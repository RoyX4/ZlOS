...
# kernel/docs/evidence/exercises/2026-08-24

## Purpose

Exercise bundles captured on 2026-08-24.

## Classification

- **Class:** `evidence`
- **State:** retained evidence
...
- `bios/`
- `physical-touchpad-2026-08-24/`
- `uefi/`

## Direct tracked contents

- `PERFORMANCE-EVIDENCE-2026-08-24.md`
- `PHYSICAL-DEBUG-QEMU-EVIDENCE-2026-08-24.md`
- `performance-architecture-evidence-2026-08-24.tar.zst`
- `physical-debug-qemu-evidence-2026-08-24.tar.zst`
