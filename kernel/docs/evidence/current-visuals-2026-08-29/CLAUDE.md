...
# Local agent contract: `kernel/docs/evidence/current-visuals-2026-08-29/`

## Scope

Dated visual evidence bundle captured on 2026-08-29. This file adds local constraints to every ancestor `AGENTS.md`;
