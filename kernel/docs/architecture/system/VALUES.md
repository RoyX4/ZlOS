...
# Values: `kernel/docs/architecture/system/`

- **Truthful status.** Apply it to every change in this directory.
- **Durable context.** Apply it to every change in this directory.
- **One clear authority.** Apply it to every change in this directory.
