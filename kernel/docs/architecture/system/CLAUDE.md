...
# Local agent contract: `kernel/docs/architecture/system/`

## Scope

System-wide ABI, audit, memory, process, and service contracts. This file adds local constraints to every ancestor `AGENTS.md`;
