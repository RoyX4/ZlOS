...
# Status: `kernel/docs/architecture/system/`

| Field | Current value |
|---|---|
| Purpose | System-wide ABI, audit, memory, process, and service contracts. |
| Class | `documentation` |
| Directory state | current or status-qualified documentation |
