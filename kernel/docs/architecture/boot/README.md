...
# kernel/docs/architecture/boot

## Purpose

Boot-route, handover, and loader architecture contracts.
...
- `boot-architecture-decision.md`
- `persistent-boot-observer.md`
- `typed-boot-handover.md`
