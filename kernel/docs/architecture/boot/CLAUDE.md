...
# Local agent contract: `kernel/docs/architecture/boot/`

## Scope

Boot-route, handover, and loader architecture contracts. This file adds local constraints to every ancestor `AGENTS.md`;
