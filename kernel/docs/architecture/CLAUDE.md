...
# Local agent contract: `kernel/docs/architecture/`

## Scope

Current zlOS architecture contracts grouped by subsystem. This file adds local constraints to every ancestor `AGENTS.md`;
