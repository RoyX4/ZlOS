...
# Local agent contract: `kernel/docs/receipts/`

## Scope

Machine-readable evidence, recovery archives, and provenance receipts. This file adds local constraints to every ancestor `AGENTS.md`;
