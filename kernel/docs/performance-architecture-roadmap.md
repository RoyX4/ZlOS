...
**Updated 2026-08-21.** This is the decision document for making the physical
...
Windows, Apple and Linux documentation. It is deliberately a roadmap and test
contract, not a claim that the work below has already landed.
...
The weakest link is implementation proof. The architecture and bottleneck are
now evidence-backed; the retained surface change still needs the above physical
before/after journal to earn the claim.
