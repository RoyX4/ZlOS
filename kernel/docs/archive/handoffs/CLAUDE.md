...
# Local agent contract: `kernel/docs/archive/handoffs/`

## Scope

Older kernel handoffs retained as dated history. This file adds local constraints to every ancestor `AGENTS.md`;
