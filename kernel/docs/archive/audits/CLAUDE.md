...
# Local agent contract: `kernel/docs/archive/audits/`

## Scope

Superseded kernel audit snapshots retained for provenance. This file adds local constraints to every ancestor `AGENTS.md`;
