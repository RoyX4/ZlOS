...
# Local agent contract: `kernel/docs/archive/`

## Scope

Kernel documentation that is historical rather than current authority. This file adds local constraints to every ancestor `AGENTS.md`;
