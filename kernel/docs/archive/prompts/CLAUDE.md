...
# Local agent contract: `kernel/docs/archive/prompts/`

## Scope

Completed or superseded kernel work prompts. This file adds local constraints to every ancestor `AGENTS.md`;
