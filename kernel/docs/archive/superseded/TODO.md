...
# Tasks: `kernel/docs/archive/superseded/`

This directory is classified as `archive`, so it has no default active implementation queue. Changes must originate in the current owner, generator, or a new superseding receipt.
