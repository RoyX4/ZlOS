...
# Local agent contract: `kernel/docs/archive/superseded/`

## Scope

Kernel plans replaced by current contracts or evidence. This file adds local constraints to every ancestor `AGENTS.md`;
