...
```
Read kernel/docs/PLATFORM-PROMPT.md in full and execute it exactly as written.
...
kernel/docs/desktop-overnight-run.md what landed 2026-08-17/18 and what it cost
...
[`../ui.h`](../ui.h) · Wiring: [`desktop-wiring.md`](desktop-wiring.md) ·
History: [`desktop-overnight-run.md`](desktop-overnight-run.md) · Blocks:
`../../.ultra/TENSIONS.md`
