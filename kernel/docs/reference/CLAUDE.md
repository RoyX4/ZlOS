...
# Local agent contract: `kernel/docs/reference/`

## Scope

Stable zlOS specifications grouped by system and interface. This file adds local constraints to every ancestor `AGENTS.md`;
