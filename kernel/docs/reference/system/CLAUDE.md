...
# Local agent contract: `kernel/docs/reference/system/`

## Scope

Stable system, memory, input, and boot references. This file adds local constraints to every ancestor `AGENTS.md`;
