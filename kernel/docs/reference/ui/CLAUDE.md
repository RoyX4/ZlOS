...
# Local agent contract: `kernel/docs/reference/ui/`

## Scope

Stable UI conventions and interface reference. This file adds local constraints to every ancestor `AGENTS.md`;
