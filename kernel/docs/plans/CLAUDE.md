...
# Local agent contract: `kernel/docs/plans/`

## Scope

Current or explicitly status-qualified kernel implementation plans. This file adds local constraints to every ancestor `AGENTS.md`;
