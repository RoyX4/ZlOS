...
# Local agent contract: `kernel/docs/concepts/`

## Scope

Bounded feasibility, ownership, and system-concept explanations. This file adds local constraints to every ancestor `AGENTS.md`;
