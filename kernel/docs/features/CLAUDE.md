...
# Local agent contract: `kernel/docs/features/`

## Scope

Feature-specific zlOS contracts and implementation notes. This file adds local constraints to every ancestor `AGENTS.md`;
