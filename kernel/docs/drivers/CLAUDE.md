...
# Local agent contract: `kernel/docs/drivers/`

## Scope

Current driver documentation grouped by hardware domain. This file adds local constraints to every ancestor `AGENTS.md`;
