...
# Local agent contract: `kernel/docs/drivers/display/`

## Scope

Display and Intel graphics implementation documentation. This file adds local constraints to every ancestor `AGENTS.md`;
