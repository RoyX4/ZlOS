...
# Local agent contract: `kernel/docs/drivers/network/`

## Scope

Network-device implementation and evidence ladders. This file adds local constraints to every ancestor `AGENTS.md`;
