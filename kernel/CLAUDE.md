...
# Local agent contract: `kernel/`

## Scope

zlOS product root, build entry points, source manifest, and kernel orientation. This file adds local constraints to every ancestor `AGENTS.md`;
