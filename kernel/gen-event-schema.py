...
def validate(value: dict) -> None:
    ...
    expected_identity = json.loads((HERE / "build-identity.json").read_text())[
        "identity_sha256"]
    ...
    expected_sources = {
        path: sha256(HERE / path) for path in
        ("hosttest/trace_event.h", "hosttest/trace_event.c", "hosttest/eventtracetest.c",
