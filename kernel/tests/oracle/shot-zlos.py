...
kernel/tests/refrender/out/reference-1280x800.png from the mockup; diff-regions.py
...
Output: kernel/tests/oracle/out/zlos-<name>.png
...
The real desktop and its twenty-odd apps are in kernel/src/kernel.zl. So wmshot
