...
set -e
cd "$(dirname "$0")"
# Temporary compatibility while source files still include sibling headers by
# basename. Phase 2 replaces this with component-owned public include paths.
HOST_INCLUDES=$(find ../../src -type d -printf ' -I%p' | sort)
gcc $HOST_INCLUDES -O1 -g -Wall -DZL_64 -Wno-unused-function -o intel_probe \
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o modeset_test modeset_test.c
...
gcc $HOST_INCLUDES -O2 -w -pthread -o fbbench fbbench.c \
    ../../src/graphics/framebuffer/fb.c ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
gcc $HOST_INCLUDES -O2 -w -o walltest walltest.c \
    ../../src/graphics/framebuffer/fb.c ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
# be drawn instead.
gcc $HOST_INCLUDES -O2 -w -o termwrap termwrap.c ../../src/graphics/windowing/term.c
...
# ../../src/kernel.zl, ../../src/graphics/ui/settings.c and ../../../docs/design/.
...
gcc $HOST_INCLUDES -O2 -Wall -Wextra -o palette palette.c ../../src/graphics/ui/ui.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -Wno-unused-parameter -D_GNU_SOURCE -o fbtext fbtext.c \
    ../../src/graphics/framebuffer/fb.c ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
gcc $HOST_INCLUDES -O2 -w -o inputtest_hid inputtest_hid.c ../../src/drivers/input/input.c
echo "built ./inputtest_hid (run: ./inputtest_hid)"

# The real touchpad transport cannot run under QEMU, but controller selection
# and LPSS wrapper setup are deterministic.  This gate proves the SPI flash
# controller is excluded before pci_enable() and checks reset/remap/timing.
gcc $HOST_INCLUDES -O2 -Wall -Wextra -Werror -DZL_64 -o i2ctest \
    i2ctest.c ../../src/drivers/input/i2c_hid.c ../../src/drivers/input/i2c_touch.c
echo "built ./i2ctest       (run: ./i2ctest)"

gcc $HOST_INCLUDES -O2 -Wall -Wextra -Werror -o i2c_touchtest \
    i2c_touchtest.c ../../src/drivers/input/i2c_touch.c
echo "built ./i2c_touchtest (run: ./i2c_touchtest)"
...
gcc $HOST_INCLUDES -O2 -w -o wmtest wmtest.c ../../src/graphics/windowing/wm.c ../../src/graphics/ui/ease.c ../../src/graphics/ui/notify.c ../../src/graphics/ui/snap.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c ../../src/graphics/windowing/wmglue.c ../../src/graphics/ui/settings.c hoststubs.c ../../src/graphics/framebuffer/fb.c ../../src/drivers/input/input.c \
    ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
echo "built ./wmtest        (run: ./wmtest)"
gcc $HOST_INCLUDES -O2 -w -o wmtest_feel wmtest_feel.c ../../src/graphics/windowing/wm.c ../../src/graphics/ui/ease.c ../../src/graphics/ui/notify.c ../../src/graphics/ui/snap.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c ../../src/graphics/windowing/wmglue.c ../../src/graphics/ui/settings.c hoststubs.c ../../src/graphics/framebuffer/fb.c ../../src/drivers/input/input.c \
    ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
gcc $HOST_INCLUDES -O2 -w -o wmshot wmshot.c ../../src/graphics/windowing/wm.c ../../src/graphics/ui/ease.c ../../src/graphics/ui/notify.c ../../src/graphics/ui/snap.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c ../../src/graphics/windowing/wmglue.c ../../src/graphics/ui/settings.c hoststubs.c ../../src/graphics/framebuffer/fb.c ../../src/drivers/input/input.c \
    ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
gcc $HOST_INCLUDES -O2 -w -o wmbench wmbench.c ../../src/graphics/windowing/wm.c ../../src/graphics/ui/ease.c ../../src/graphics/ui/notify.c ../../src/graphics/ui/snap.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c ../../src/graphics/windowing/wmglue.c ../../src/graphics/ui/settings.c hoststubs.c ../../src/graphics/framebuffer/fb.c ../../src/drivers/input/input.c \
    ../../src/graphics/windowing/term.c ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
gcc $HOST_INCLUDES -O2 -w -o tritest tritest.c ../../src/graphics/framebuffer/fb3d.c ../../src/graphics/framebuffer/fb.c \
    ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
if [ -f /usr/include/GL/glx.h ] && [ -f gpu_fillrate.c ]; then
  gcc $HOST_INCLUDES -O2 -w -o gpu_fillrate gpu_fillrate.c -lGL -lX11
...
# #include ../../src/net/crypto.c rather than linking it: the file has no header of its
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -D_GNU_SOURCE -o cryptotest cryptotest.c
echo "built ./cryptotest    (run: ./cryptotest)"
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -D_GNU_SOURCE -o tlscryptotest tlscryptotest.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o jstest jstest.c ../../src/web/js.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -D_GNU_SOURCE -o ecdsatest ecdsatest.c ../../src/net/ecdsa.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -D_GNU_SOURCE -o x509test x509test.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/crypto.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o htmltest htmltest.c ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o csstest csstest.c ../../src/web/css.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o parsestat parsestat.c \
    ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c
...
gcc $HOST_INCLUDES -O2 -w -o browsershot browsershot.c ../../src/web/browser.c ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c ../../src/graphics/image/png.c \
    ../../src/net/tls.c ../../src/net/crypto.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/roots.c ../../src/net/entropy.c ../../src/web/js.c hostmachine.c \
    ../../src/graphics/ui/ui.c ../../src/graphics/framebuffer/fb.c ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c \
    ../../src/net/http.c ../../src/net/tcp.c ../../src/net/net.c ../../src/net/dns.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o nettest nettest.c ../../src/net/net.c
echo "built ./nettest       (run: ./nettest)"
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o dhcptest dhcptest.c ../../src/net/dhcp.c ../../src/net/net.c
echo "built ./dhcptest      (run: ./dhcptest)"
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -Wno-unused-parameter -DE1000_HOSTTEST -no-pie \
    -o e1000test e1000test.c ../../src/drivers/network/e1000.c
echo "built ./e1000test     (run: ./e1000test)"
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -DIWLWIFI_HOSTTEST \
    -o iwlwifitest iwlwifitest.c ../../src/drivers/network/iwlwifi.c ../../src/net/crypto.c
echo "built ./iwlwifitest   (run: ./iwlwifitest)"
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o tcptest tcptest.c ../../src/net/tcp.c ../../src/net/net.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o httptest httptest.c ../../src/net/http.c ../../src/net/tcp.c ../../src/net/net.c \
    ../../src/net/tls.c ../../src/net/crypto.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/roots.c ../../src/net/entropy.c hostmachine.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o browsertest browsertest.c ../../src/web/browser.c \
    ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c ../../src/graphics/image/png.c ../../src/net/http.c ../../src/net/tcp.c ../../src/net/net.c ../../src/net/dns.c \
    ../../src/net/tls.c ../../src/net/crypto.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/roots.c ../../src/net/entropy.c ../../src/web/js.c hostmachine.c
...
# different harness.
gcc $HOST_INCLUDES -O1 -g -w -D_GNU_SOURCE -fsanitize=address,undefined -fno-sanitize-recover=all \
    -o browsertest_san browsertest.c ../../src/web/browser.c \
    ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c ../../src/graphics/image/png.c ../../src/net/http.c ../../src/net/tcp.c ../../src/net/net.c ../../src/net/dns.c \
    ../../src/net/tls.c ../../src/net/crypto.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/roots.c ../../src/net/entropy.c ../../src/web/js.c hostmachine.c
...
gcc $HOST_INCLUDES -O1 -g -w -D_GNU_SOURCE -fsanitize=address,undefined -o fuzz fuzz.c \
    ../../src/web/html.c ../../src/web/css.c ../../src/web/layout.c ../../src/graphics/image/png.c ../../src/net/net.c ../../src/net/tcp.c ../../src/net/http.c \
    ../../src/net/tls.c ../../src/net/crypto.c ../../src/net/x509.c ../../src/net/ecdsa.c ../../src/net/rsa.c ../../src/net/roots.c ../../src/net/entropy.c \
    hostmachine.c
...
gcc -O1 -g -Wall -Wextra -Werror -D_GNU_SOURCE \
    ...
    -o pngtest pngtest.c ../../src/graphics/image/png.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -D_GNU_SOURCE -o dnstest dnstest.c ../../src/net/dns.c ../../src/net/net.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -Wno-unused-function -o inputtest \
    inputtest.c ../../src/drivers/input/input.c
...
gcc $HOST_INCLUDES -O1 -g -w -D_GNU_SOURCE -DZL_64 -o xhcitest xhcitest.c ../../src/drivers/input/input.c
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -Wno-unused-function -DZL_64 \
    -o msctest msctest.c
echo "built ./msctest       (run: ./msctest)"

gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -Wno-unused-function -o inputtest_feel \
    inputtest_feel.c ../../src/drivers/input/input.c
...
gcc $HOST_INCLUDES -O2 -w -o libctest libctest.c ../../src/runtime/interp_kernel.c ../../src/core/arena.c -lm
echo "built ./libctest      (run: ./libctest)"

gcc $HOST_INCLUDES -O2 -w -o arenatest arenatest.c ../../src/core/arena.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o boot_handover_test \
...
gcc $HOST_INCLUDES -O1 -g -Wall -Wextra -Werror -fsanitize=address,undefined \
    -fno-sanitize-recover=all -DCRASH_HOSTTEST \
    -o crashtest crashtest.c ../../src/core/crash.c
...
gcc $HOST_INCLUDES -O2 -w -o exectest exectest.c ../../src/core/exec.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -Wno-unused-parameter \
    -o systest systest.c ../../src/graphics/windowing/clip.c ../../src/graphics/ui/snap.c ../../src/graphics/ui/notify.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -Wno-unused-parameter -DRTC_HOSTTEST \
    -o rtctest rtctest.c ../../src/arch/x86/rtc.c
...
gcc $HOST_INCLUDES -O2 -w -o toasttest toasttest.c ../../src/graphics/windowing/wm.c ../../src/graphics/ui/ease.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c ../../src/graphics/windowing/wmglue.c ../../src/graphics/ui/settings.c hoststubs.c ../../src/graphics/framebuffer/fb.c \
    ../../src/drivers/input/input.c ../../src/graphics/ui/notify.c ../../src/graphics/ui/snap.c \
    ../../src/graphics/fonts/font8x16.c ../../src/graphics/fonts/font_aa.c ../../src/graphics/fonts/font_sub.c ../../src/graphics/icons/icons.c
...
if [ -f /usr/include/drm/i915_drm.h ]; then
  gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o gpu_blt gpu_blt.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o gputest gputest.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o gpu_ring gpu_ring.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o gpu_planes gpu_planes.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o gpu_aperture gpu_aperture.c
...
gcc $HOST_INCLUDES -O2 -g -Wall -Wextra -o uitest uitest.c ../../src/graphics/ui/ui.c ../../src/graphics/ui/uikit.c
echo "built ./uitest        (run: ./uitest)"

# The real freestanding interpreter route used by `run hello.zl`.
gcc -O2 -w -I../../.. -I../../../src/frontend -I../../../src/runtime -DZL_FREESTANDING -DBUILD_PARSER -c ../../../src/frontend/lexer.c -o _run_lex.o
gcc -O2 -w -I../../.. -I../../../src/frontend -I../../../src/runtime -DZL_FREESTANDING -DBUILD_INTERP -c ../../../src/frontend/parser.c -o _run_par.o
gcc -O2 -w -I../../.. -I../../../src/frontend -I../../../src/runtime -DZL_FREESTANDING -c ../../../src/runtime/interp.c -o _run_int.o
gcc $HOST_INCLUDES -O2 -w -I../../.. -I../../../src/runtime -o runtest runtest.c ../../src/core/exec.c ../../src/runtime/interp_kernel.c ../../src/arch/x86/ksetjmp.S \
