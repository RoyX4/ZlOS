...
#
# ../../tools/checks/check-memmap.sh opens ONE file:
#
#     SRC=${1:-kernel.zl}
#
...
#
#     kernel/apps/apps_games3.zl   6 fixed addresses, 0x02240000..0x02245000
#     kernel/apps/apps_games4.zl   4 fixed addresses, 0x02280000..0x02283000
#
