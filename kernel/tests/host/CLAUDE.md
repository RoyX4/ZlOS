...
# Local agent contract: `kernel/tests/host/`

## Scope

Host-compiled harnesses for kernel components and hardware-facing logic. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Make every check capable of failing for the behavior it claims to cover.
