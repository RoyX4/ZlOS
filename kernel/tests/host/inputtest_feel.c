/* inputtest_feel.c - feel's pointer acceleration, the scroll wheel and the settings sinks.
 *
 * This is desktop/feel-and-control's rewrite of inputtest.c. It was NOT merged
...
/* input.c reads the USB wheel through this - see the note in inputtest.c. */
