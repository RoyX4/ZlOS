...
# Status: `kernel/tests/host/`

| Field | Current value |
|---|---|
| Purpose | Host-compiled harnesses for kernel components and hardware-facing logic. |
| Class | `tests` |
| Directory state | active verification support |
| Product completion | Not determined by this directory |
| Evidence boundary | Tests describe exercised behavior; they do not prove unexecuted routes or physical hardware. |
