...
# Local agent contract: `kernel/tests/`

## Scope

zlOS host tests, fixtures, independent oracles, and reference renderers. This file adds local constraints to every ancestor `AGENTS.md`;
