...
# Tasks: `kernel/tests/refrender/vendor/`

This directory is classified as `vendor`, so it has no default active implementation queue. Changes must originate in the current owner, generator, or a new superseding receipt.
