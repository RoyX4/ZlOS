...
# Local agent contract: `kernel/tests/refrender/vendor/`

## Scope

Pinned third-party JavaScript used by the reference renderer. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Preserve upstream bytes and provenance; isolate local adaptation outside the vendor directory.
