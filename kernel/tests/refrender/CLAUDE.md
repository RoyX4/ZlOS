...
# Local agent contract: `kernel/tests/refrender/`

## Scope

Browser-based reference renderer for visual comparison. This file adds local constraints to every ancestor `AGENTS.md`;
