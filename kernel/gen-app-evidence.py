...
OUTPUT = os.path.join(HERE, "app-evidence.json")
RECEIPTS = {
    "routes": os.path.join(HERE, "docs", "receipts", "app-routes-qemu-2026-08-22.json"),
    "catalogue": os.path.join(HERE, "docs", "receipts", "app-lifecycle-qemu-2026-08-22.json"),
    "run": os.path.join(HERE, "docs", "receipts", "run-qemu-2026-08-22.json"),
}
BOOT_RECEIPTS = {
    "raw-bios": os.path.join(HERE, "docs", "receipts", "app-manifest-raw-bios-qemu-2026-08-22.json"),
    "native-uefi64": os.path.join(HERE, "docs", "receipts", "app-manifest-native-uefi64-qemu-2026-08-22.json"),
    "grub-bios32": os.path.join(HERE, "docs", "receipts", "app-manifest-grub-bios32-qemu-2026-08-22.json"),
    "grub-uefi32": os.path.join(HERE, "docs", "receipts", "app-manifest-grub-uefi32-qemu-2026-08-22.json"),
    "grub-bios64": os.path.join(HERE, "docs", "receipts", "app-manifest-grub-bios64-qemu-2026-08-22.json"),
    "grub-uefi64": os.path.join(HERE, "docs", "receipts", "app-manifest-grub-uefi64-qemu-2026-08-22.json"),
}
