...
def measure(font):
    """(cell width needed, advances). The cell must hold the widest INK box,
    including any part that sits left of the pen (a negative bearing)."""
    wide, advs = 0, []
    for ch in CHARS:
...
def build(cell_h):
    ...
    return glyphs, advs, cell_w, size
...
def main():
    small, s_adv, s_cw, s_sz = build(16)
    big,   b_adv, b_cw, b_sz = build(32)
