...
# Local agent contract: `kernel/src/drivers/input/`

## Scope

PS/2, USB HID, I2C HID, and input-routing drivers. This file adds local constraints to every ancestor `AGENTS.md`;
