...
# Status: `kernel/src/drivers/display/assets/`

| Field | Current value |
|---|---|
| Purpose | Generated or captured binary include data consumed by display drivers. |
| Class | `generated` |
| Directory state | generated truth surface |
| Product completion | Not determined by this directory |
| Evidence boundary | The owning source and generator are authoritative; direct edits are not. |
