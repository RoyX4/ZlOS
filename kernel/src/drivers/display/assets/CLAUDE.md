...
# Local agent contract: `kernel/src/drivers/display/assets/`

## Scope

Generated or captured binary include data consumed by display drivers. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Change the owning source or generator and regenerate; do not hand-edit generated truth.
