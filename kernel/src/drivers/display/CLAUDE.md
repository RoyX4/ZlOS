...
# Local agent contract: `kernel/src/drivers/display/`

## Scope

Framebuffer, BGA, Intel display, and GPU-assist drivers. This file adds local constraints to every ancestor `AGENTS.md`;
