...
# Local agent contract: `kernel/src/drivers/network/`

## Scope

PCI, virtio, Ethernet, and Wi-Fi network-device drivers. This file adds local constraints to every ancestor `AGENTS.md`;
