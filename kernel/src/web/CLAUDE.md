...
# Local agent contract: `kernel/src/web/`

## Scope

Browser parsing, style, layout, scripting, and rendering support. This file adds local constraints to every ancestor `AGENTS.md`;
