...
# Local agent contract: `kernel/src/graphics/`

## Scope

Graphics implementation grouped by rendering concern. This file adds local constraints to every ancestor `AGENTS.md`;
