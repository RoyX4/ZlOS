...
# Values: `kernel/src/graphics/framebuffer/`

- **Clear ownership.** Apply it to every change in this directory.
- **Small reversible changes.** Apply it to every change in this directory.
- **Reachability before claims.** Apply it to every change in this directory.
