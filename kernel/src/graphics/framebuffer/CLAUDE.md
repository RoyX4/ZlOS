...
# Local agent contract: `kernel/src/graphics/framebuffer/`

## Scope

Framebuffer primitives and presentation support. This file adds local constraints to every ancestor `AGENTS.md`;
