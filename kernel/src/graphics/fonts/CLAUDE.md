...
# Local agent contract: `kernel/src/graphics/fonts/`

## Scope

Font data, glyph rendering, and text-rasterization support. This file adds local constraints to every ancestor `AGENTS.md`;
