...
# Local agent contract: `kernel/src/graphics/windowing/`

## Scope

Window manager, compositor, retained surfaces, and input dispatch. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Keep implementation with its owning subsystem and update consumers, manifests, and focused checks together.
