...
# Local agent contract: `kernel/src/graphics/ui/`

## Scope

UI controls, themes, shell surfaces, and application-facing widgets. This file adds local constraints to every ancestor `AGENTS.md`;
