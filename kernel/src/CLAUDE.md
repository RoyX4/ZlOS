...
# Local agent contract: `kernel/src/`

## Scope

Shipped zlOS implementation grouped by architecture and subsystem. This file adds local constraints to every ancestor `AGENTS.md`;
