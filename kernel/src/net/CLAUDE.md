...
# Local agent contract: `kernel/src/net/`

## Scope

Network stack protocols, sockets, DHCP, DNS, HTTP, and TLS support. This file adds local constraints to every ancestor `AGENTS.md`;
