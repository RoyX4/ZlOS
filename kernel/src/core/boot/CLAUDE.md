...
# Local agent contract: `kernel/src/core/boot/`

## Scope

Typed boot handover and recovery-policy integration. This file adds local constraints to every ancestor `AGENTS.md`;
