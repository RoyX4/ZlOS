...
# Local agent contract: `kernel/src/core/`

## Scope

Core kernel services shared across boot routes and subsystems. This file adds local constraints to every ancestor `AGENTS.md`;
