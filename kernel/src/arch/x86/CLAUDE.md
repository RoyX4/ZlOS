...
# Local agent contract: `kernel/src/arch/x86/`

## Scope

x86 and x86-64 CPU, interrupt, paging, syscall, and low-level support. This file adds local constraints to every ancestor `AGENTS.md`;
