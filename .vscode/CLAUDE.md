...
# Local agent contract: `.vscode/`

## Scope

Shared VS Code tasks, launch configuration, and C/C++ indexing settings. This file adds local constraints to every ancestor `AGENTS.md`;
