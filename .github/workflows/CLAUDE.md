...
# Local agent contract: `.github/workflows/`

## Scope

Continuous integration, boot, documentation, and scheduled workflows. This file adds local constraints to every ancestor `AGENTS.md`;
