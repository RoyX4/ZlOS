...
# Local agent contract: `.github/`

## Scope

GitHub-facing contribution guidance and automation configuration. This file adds local constraints to every ancestor `AGENTS.md`;
