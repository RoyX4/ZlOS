...
# Local agent contract: `docs/`

## Scope

Repository-wide project status, architecture, program, evidence, and history. This file adds local constraints to every ancestor `AGENTS.md`;
