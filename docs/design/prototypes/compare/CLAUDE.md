...
# Local agent contract: `docs/design/prototypes/compare/`

## Scope

Generated comparison sheets for preserved desktop prototypes. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Label plans, decisions, current state, evidence, and history so they cannot be confused.
