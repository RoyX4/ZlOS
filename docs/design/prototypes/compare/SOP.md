...
# Standard operating procedure: `docs/design/prototypes/compare/`
...
For capsule maintenance, follow the [directory documentation plan](../../directory-documentation-system.md) and run
