...
# Local agent contract: `docs/design/prototypes/render/`

## Scope

Rendered scene captures from preserved desktop prototypes. This file adds local constraints to every ancestor `AGENTS.md`;
