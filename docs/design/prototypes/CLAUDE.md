...
# Local agent contract: `docs/design/prototypes/`

## Scope

Preserved interactive desktop design prototypes. This file adds local constraints to every ancestor `AGENTS.md`;
