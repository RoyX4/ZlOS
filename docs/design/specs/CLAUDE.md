...
# Local agent contract: `docs/design/specs/`

## Scope

Frozen machine-readable specifications for desktop design directions. This file adds local constraints to every ancestor `AGENTS.md`;
