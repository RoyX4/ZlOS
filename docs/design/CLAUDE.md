...
# Local agent contract: `docs/design/`

## Scope

Design proposals, decisions, implementation plans, and visual prototypes. This file adds local constraints to every ancestor `AGENTS.md`;
