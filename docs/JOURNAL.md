...
## 2026-09-09 — fix: adversarial pass on the re-plug batch - six defects, all pinned (a0a72eb4)

`fable/usb-replug` · 35 files changed, 830 insertions(+), 618 deletions(-)
...
<details><summary>38 file(s)</summary>
...
- `docs/PROJECT-STATUS.md`
- `docs/evidence/whole-tree-sweep-2026-09-04.md`
- `docs/oracle-harnesses-for-driver-verification.md`
- `kernel/boot/gdt64.c`
- `kernel/build_identity_embed.zl`
- `kernel/docs/guides/thinkpad-first-boot.md`
- `kernel/docs/receipts/app-manifest-grub-bios32-qemu-2026-08-22.json`
- `kernel/docs/receipts/app-manifest-grub-bios64-qemu-2026-08-22.json`
- _…and 26 more_
...
<details><summary>116 file(s)</summary>
...
## 2026-08-30 — Merge pull request #9 from RoyX4/codex/final-topology-cleanup-2026-08-30 (43a81ec)

`main` · 6 files changed, 146 insertions(+), 39 deletions(-)
...
## 2026-08-30 — ci: bind EFI receipts to the current runner (bb31de4)

`codex/consolidate-all-2026-08-30` · 2 files changed, 31 insertions(+), 1 deletion(-)
