...
# Local agent contract: `docs/fleet/`

## Scope

Audit boards, review findings, and verification logs for coordinated work. This file adds local constraints to every ancestor `AGENTS.md`;
