...
# Local agent contract: `docs/archive/`

## Scope

Repository-level historical material that is no longer current authority. This file adds local constraints to every ancestor `AGENTS.md`;
