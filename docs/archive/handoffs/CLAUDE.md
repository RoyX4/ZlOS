...
# Local agent contract: `docs/archive/handoffs/`

## Scope

Superseded repository handoffs retained for history. This file adds local constraints to every ancestor `AGENTS.md`;
