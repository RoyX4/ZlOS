...
# Local agent contract: `docs/archive/backups/`

## Scope

Preserved backup inputs retained for provenance rather than active use. This file adds local constraints to every ancestor `AGENTS.md`;
