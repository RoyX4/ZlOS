...
# Values: `docs/archive/backups/ci-session-scratch/`

- **Historical fidelity.** Apply it to every change in this directory.
- **Clear deactivation.** Apply it to every change in this directory.
- **Recoverable context.** Apply it to every change in this directory.
