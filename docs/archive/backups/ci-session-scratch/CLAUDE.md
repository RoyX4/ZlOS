...
# Local agent contract: `docs/archive/backups/ci-session-scratch/`

## Scope

Recovered CI-session scratch material retained as a historical input. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Canonical [project status](../../../PROJECT-STATUS.md) and [code map](../../../CODE-MAP.md).
...
- Do not execute or cite archived material as current authority without revalidation.
