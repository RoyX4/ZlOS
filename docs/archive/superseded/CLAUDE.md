...
# Local agent contract: `docs/archive/superseded/`

## Scope

Plans and scorecards replaced by newer project authorities. This file adds local constraints to every ancestor `AGENTS.md`;
