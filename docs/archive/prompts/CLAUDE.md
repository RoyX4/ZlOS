...
# Local agent contract: `docs/archive/prompts/`

## Scope

Completed or superseded prompts retained to explain how work was commissioned. This file adds local constraints to every ancestor `AGENTS.md`;
