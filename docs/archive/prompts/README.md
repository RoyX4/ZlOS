...
Completed or superseded prompts retained to explain how work was commissioned.
...
- Read the [project status](../../PROJECT-STATUS.md) for current truth.
...
- `DOCS-RECONCILE-PROMPT.md`
- `OVERNIGHT_CAMPAIGN.md`
