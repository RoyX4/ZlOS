...
# Status: `docs/program/research/language/`

| Field | Current value |
|---|---|
| Purpose | Language-specific research and implementation-gap analysis. |
| Class | `documentation` |
...
[project status](../../../PROJECT-STATUS.md). Product work is tracked in the [remaining-work map](../../../REMAINING-WORK.md) and [complete program](../../README.md).
