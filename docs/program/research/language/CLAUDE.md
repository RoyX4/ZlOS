...
# Local agent contract: `docs/program/research/language/`

## Scope

Language-specific research and implementation-gap analysis. This file adds local constraints to every ancestor `AGENTS.md`;
