...
- current zlOS `kernel/HANDOFF.md`, `kernel/docs/visual-speed-northstar.md`, `kernel/docs/desktop/look-and-speed.md`, `kernel/docs/evidence/desktop-scale-and-effects.md`, `kernel/docs/evidence/desktop-feel.md`, and `kernel/docs/plans/retained-window-surfaces.md` in `/home/roy/Documents/repos/zl-linux`
