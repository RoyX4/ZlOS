...
# Local agent contract: `docs/program/research/`

## Scope

Complete source-research shelf feeding the normalized product program. This file adds local constraints to every ancestor `AGENTS.md`;
