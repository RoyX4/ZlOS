...
# Local agent contract: `docs/program/`

## Scope

Normalized product program, phase model, contracts, registries, and status data. This file adds local constraints to every ancestor `AGENTS.md`;
