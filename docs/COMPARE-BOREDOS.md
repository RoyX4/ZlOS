...
1. **It ships.** Ten tagged releases, ISOs, a nightly. zlOS has zero, and
   ...
   files independently and will conflict. See `docs/INTEGRATION-PLAN.md`.
...
- The zlOS union is a *projection*. Where two tracks edited different
  ...
  figure. It also excludes `kernel/font_prop.inc` (~14k lines of generated
...
- `docs/CODE-MAP.md`, `docs/INTEGRATION-PLAN.md`, `kernel/HANDOFF.md`
