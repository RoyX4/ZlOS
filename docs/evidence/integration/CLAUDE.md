...
# Local agent contract: `docs/evidence/integration/`

## Scope

Receipts for branch, worktree, clone, and publication integration. This file adds local constraints to every ancestor `AGENTS.md`;
