...
# Local agent contract: `docs/evidence/`

## Scope

Measured repository-level receipts and dated audit evidence. This file adds local constraints to every ancestor `AGENTS.md`;
