...
# Local agent contract: `docs/evidence/status-audits/`

## Scope

Dated project-state audits retained as evidence snapshots. This file adds local constraints to every ancestor `AGENTS.md`;
