...
# Local agent contract: `docs/evidence/visual-diffs/`

## Scope

Curated before-and-after visual comparisons with retained context. This file adds local constraints to every ancestor `AGENTS.md`;
...
- Preserve dated observations; add a superseding receipt instead of rewriting history.
