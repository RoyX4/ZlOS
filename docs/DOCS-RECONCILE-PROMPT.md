...
1. **Items already done that nobody knows are done.** The merge implemented a
   great deal incidentally. `docs/MERGE-EVIDENCE.md` §Outcome lists what landed.
...
kernel/docs/OVERNIGHT-PROMPT.md                35 KB   <- produced 19 compositor commits
...
kernel/docs/BROWSER-PROMPT.md                  13 KB
kernel/docs/EXEC-PROMPT.md                     12 KB
kernel/docs/FEEL-PROMPT.md                     13 KB
kernel/docs/PLATFORM-PROMPT.md                 15 KB
kernel/docs/SYSTEM-PROMPT.md                   12 KB
kernel/docs/POINTER-PROMPT.md                   9 KB   <- CURRENT, do not audit, see below
docs/INTEGRATION-PLAN.md                       16 KB   <- superseded by MERGE-EVIDENCE.md
docs/design/PLAN_unboxing.md                   31 KB
docs/design/GRAPHICS_PLAN.md                    8 KB
docs/design/STDLIB_PLAN.md                      8 KB
```

Read first, before any of them: `docs/MERGE-EVIDENCE.md` (what landed and what
...
`docs/MERGE-EVIDENCE.md`, which found eight silent id collisions and a memory
...
- **`docs/INTEGRATION-PLAN.md`** is superseded by `docs/MERGE-EVIDENCE.md` and
...
From `docs/MERGE-EVIDENCE.md` §Still open:
