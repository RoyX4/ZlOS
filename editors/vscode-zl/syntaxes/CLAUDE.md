...
# Local agent contract: `editors/vscode-zl/syntaxes/`

## Scope

TextMate grammar definitions for zl syntax highlighting. This file adds local constraints to every ancestor `AGENTS.md`;
