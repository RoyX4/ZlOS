...
# Local agent contract: `editors/vscode-zl/`

## Scope

VS Code extension for zl syntax, formatting, snippets, and run commands. This file adds local constraints to every ancestor `AGENTS.md`;
