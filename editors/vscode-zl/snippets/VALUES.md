...
# Values: `editors/vscode-zl/snippets/`

- **Automation.** Apply it to every change in this directory.
- **Fail-closed behavior.** Apply it to every change in this directory.
- **Readable diagnostics.** Apply it to every change in this directory.
