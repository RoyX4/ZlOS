...
# Local agent contract: `bench/`

## Scope

Benchmark programs and runners for measured language-engine comparisons. This file adds local constraints to every ancestor `AGENTS.md`;
