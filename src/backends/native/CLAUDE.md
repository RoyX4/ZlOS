...
# Local agent contract: `src/backends/native/`

## Scope

Direct native executable generators and native-runtime experiments. This file adds local constraints to every ancestor `AGENTS.md`;
