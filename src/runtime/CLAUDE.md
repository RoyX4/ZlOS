...
# Local agent contract: `src/runtime/`

## Scope

Reference interpreter, compiled runtime, and Linux OS bridge. This file adds local constraints to every ancestor `AGENTS.md`;
