...
# Local agent contract: `.ultra/`

## Scope

Evidence-backed integration tensions and their OPEN or CLOSED state. This file adds local constraints to every ancestor `AGENTS.md`;
